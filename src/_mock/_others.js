...
export const _notifications = [...Array(3)].map((_, index) => ({
  ...
  title:
    (index === 0 && `<p>Delivery processing your order is being shipped</p>`) ||
    (index === 1 && `<p>You have new message 5 unread messages</p>`) ||
    (index === 2 && `<p>You have new mail`) ||
    '',
}));
