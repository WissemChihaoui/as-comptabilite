...
const FOLDERS = ['Certificat de rémunération annuel', 'Intérêts débiteurs', 'Assurances', 'Assurance prévoyance vieillesse', 'Epargne logement', 'Dons', 'Charges extraordinaires', 'Déclaration de partenariat', 'Une copie du décompte annuel ou de la déclaration d’impôts de l’année précédente','Revenus locatifs'];
